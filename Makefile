...
#    Updated: 2024/08/20 17:55:01 by tkannane         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME): $(objs)
		make -C libft
		$(cmd) $(cflags) $(objs) -o $@ MLXlib42/libmlx42.a -lglfw -L"/Users/$(USER)/.brew/opt/glfw/lib/" libft/libft.a

$(BNAME): $(BOBJ)
		make -C libft
		$(cmd) $(cflags) $(BOBJ) -o $@ MLXlib42/libmlx42.a -lglfw -L"/Users/$(USER)/.brew/opt/glfw/lib/" libft/libft.a
